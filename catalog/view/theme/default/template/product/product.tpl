													...
													<div class="row">
														...
														<div class="col-md-6 col-sm-6">
															<div class="info-actions-wrap">
																<a href="" class="info-actions-link popup-btn"  data-toggle="tooltip" onclick="wishlist.add('<?php echo $product_id ?>');">
																	<span class="btn-icon">
																		<span class="icon">
																			<svg>
																...
																<a href="" class="info-actions-link popup-btn" onclick="compare.add('<?php echo $product_id ?>');">
																	<span class="btn-icon">
																		<span class="icon">
																			<svg>
